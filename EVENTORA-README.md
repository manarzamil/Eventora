...
[![CI](https://github.com/USERNAME/eventora/actions/workflows/ci.yml/badge.svg)](https://github.com/USERNAME/eventora/actions/workflows/ci.yml)
...
```bash
# 1. Clone
git clone https://github.com/USERNAME/eventora.git
cd eventora
